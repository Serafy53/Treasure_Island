...
if direction == "left":
    decision = input('You came to a sea. There is an island in the middle of the sea. Type "wait" to wait for a boat. Type "swim" to swim across.\n').lower()
    if decision == "wait":
        ...
        if choice == "red":
            ...
            print("You entered a room full of hungry lions. Game Over!")
        elif choice == "yellow":
            print("Congratulation! You found the treasure.")
        else:
            print("You chose a wrong door. Game over!")
    elif decision == "swim":
        print("You were eaten by the sharks. Game over!")
